...
The page is a single self-contained HTML file. Step through all 89 half-moves; the commentary beside
the board is quoted verbatim from what the two players actually said at the time (93 direct quotes),
and there's a running tally of every occasion where Claude's own tooling caught an error it had
